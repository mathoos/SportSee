...
function PieChartComponent({ user }) {
    ...
    return (
        <div className="pie-container">   
            ...
            <ResponsiveContainer>
                <PieChart>
                    <Pie nameKey="name"cx="50%" cy="50%" startAngle={-270} stroke="none" data={data} dataKey="value" outerRadius={90} innerRadius={80} paddingAngle={0} cornerRadius={50}>
                    ...
                    <Pie nameKey="name" cx="50%" cy="50%" startAngle={-270} endAngle={90} stroke="none" dataKey="value" 
                        outerRadius={80} innerRadius={0} className="circle-path"
